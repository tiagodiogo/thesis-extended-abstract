...
\title{Secure Bootstrapping of 6LoWPAN Networks\\ to Prevent Vampire Attacks in IoT Environments}
%
...
In our work we propose AutoStrap -- a secure bootstrapping scheme capable of securing \gls{IoT} environments based on 6LoWPAN networks -- that aims to prevent ``vampire'' attacks that drain the energy of the network nodes. 
